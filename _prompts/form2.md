...
Create a NavPlace design theme for personal recipes and cooking resources.
...
Interaction:
- vertical flow
- emphasize preview images
- secondary text shows domain or category

Mood:
- cozy, home, slow browsing
